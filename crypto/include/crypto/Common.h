...
public:
	...
	static KeyPair fromEncryptedSeed(core::bytesConstRef _seed, std::string const& _password);
	...
	core::Address const& address() const { return m_address; }
