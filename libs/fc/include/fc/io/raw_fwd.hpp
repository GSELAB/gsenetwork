...
namespace fc {
   ...
   namespace raw {
    ...
    template<typename Stream, typename T, std::size_t N,
             std::enable_if<std::is_scalar<T>::value == false || std::is_pointer<T>::value == true, int> = 0> inline void pack( Stream& s, const fc::array<T,N>& v);
    template<typename Stream, typename T, std::size_t N,
             std::enable_if<std::is_scalar<T>::value == true && std::is_pointer<T>::value == false, int> = 0> inline void pack( Stream& s, const fc::array<T,N>& v);
    template<typename Stream, typename T, std::size_t N,
                 std::enable_if<std::is_scalar<T>::value == false || std::is_pointer<T>::value == true, int> = 0> inline void unpack( Stream& s, fc::array<T,N>& v);
    template<typename Stream, typename T, std::size_t N,
                 std::enable_if<std::is_scalar<T>::value == true && std::is_pointer<T>::value == false, int> = 0> inline void unpack( Stream& s, fc::array<T,N>& v);
