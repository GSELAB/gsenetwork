...
public:
	...
	explicit FixedHash(std::string const& _s, ConstructFromStringType _t = FromHex, ConstructFromHashType _ht = FailIfDifferent): FixedHash(_t == FromHex ? fromHex(_s, WhenError::Throw) : core::asBytes(_s), _ht) {}
...
namespace std
{
	...
	template<> struct hash<core::h64>: core::h64::hash {};
	template<> struct hash<core::h128>: core::h128::hash {};
	template<> struct hash<core::h160>: core::h160::hash {};
	template<> struct hash<core::h256>: core::h256::hash {};
	template<> struct hash<core::h512>: core::h512::hash {};
}
