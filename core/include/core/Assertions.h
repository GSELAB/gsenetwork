...
#define asserts(A) ::core::assertAux(A, #A, __LINE__, __FILE__, ETH_FUNC)
#define assertsEqual(A, B) ::core::assertEqualAux(A, B, #A, #B, __LINE__, __FILE__, ETH_FUNC)
...
#define assertThrow(_condition, _ExceptionType, _description) \
	::core::assertThrowAux<_ExceptionType>(_condition, _description, __LINE__, __FILE__, ETH_FUNC)
...
)
{
	if (!_condition)
		::boost::throw_exception(
			_ExceptionType() <<
			::core::errinfo_comment(_errorDescription) <<
