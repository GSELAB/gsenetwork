...
#define DEV_TIMED(S) for (::std::pair<::core::TimerHelper, bool> __eth_t(S, true); __eth_t.second; __eth_t.second = false)
#define DEV_TIMED_SCOPE(S) ::core::TimerHelper __eth_t(S)
#if defined(_WIN32)
...
#define DEV_TIMED_ABOVE(S, MS) for (::std::pair<::core::TimerHelper, bool> __eth_t(::core::TimerHelper(S, MS), true); __eth_t.second; __eth_t.second = false)
#define DEV_TIMED_SCOPE_ABOVE(S, MS) ::core::TimerHelper __eth_t(S, MS)
#if defined(_WIN32)
